...
export const companyWiseData: CompanyWiseData[] = [
  {
    company: "Google",
    total: 40,
    branches: { CSE: 35, ECE: 5, EEE: 0, MECH: 0, CIVIL: 0 },
  },
  {
    company: "Microsoft",
    total: 38,
    branches: { CSE: 30, ECE: 8, EEE: 0, MECH: 0, CIVIL: 0 },
  },
  {
    company: "Amazon",
    total: 52,
    branches: { CSE: 45, ECE: 7, EEE: 0, MECH: 0, CIVIL: 0 },
  },
  {
    company: "Infosys",
    total: 67,
    branches: { CSE: 40, ECE: 15, EEE: 8, MECH: 4, CIVIL: 0 },
  },
  {
    company: "TCS",
    total: 89,
    branches: { CSE: 45, ECE: 20, EEE: 15, MECH: 9, CIVIL: 0 },
  },
  {
    company: "Accenture",
    total: 76,
    branches: { CSE: 38, ECE: 18, EEE: 12, MECH: 8, CIVIL: 0 },
  },
];
